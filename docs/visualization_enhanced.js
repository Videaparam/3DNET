...
function loadData() {
    d3.csv("docs/sampled_nodes_test_edgebundling.csv").then(data => {
...
// Edge management
function loadEdges() {
    const edgeFile = useBundledEdges ? "docs/bundled_output_dijkstra.csv" : "docs/sampled_edges_test_edgebundling.csv";
